...
def run_test(
    vtree_filename, sdd_filename, N=1024, seed=0, print_models=True, test_learning=True
):
...
def run_test_basename(basename, test_learning=True):
    ...
    alpha, pmanager = run_test(
        vtree_filename, sdd_filename, test_learning=test_learning
    )
    print()
